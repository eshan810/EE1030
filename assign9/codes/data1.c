...
#include <math.h>
int main() {
// Function to write points P and Q to a file
void write_points_to_file(const char *filename, float x1, float y1, float z1, float x2, float y2, float z2) {
...
float sqrt_newton_raphson(float number) {
    ...
    // Write points P and Q to a file
    write_points_to_file("output.txt", x1, y1, z1, x2, y2, z2);

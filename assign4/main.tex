...
\solution{ Given, \begin{align}
               ...
               So, the coefficient matrix $A = \myvec{3 & -1 \\ 6 & -r}$\\
                ...
                so, \sbrak {A|B} &= \myvec{3 & -1 | & -8 \\ 6 & -r | & -16}
              \end{align}
              Performing row operations$\colon$ $R_2 - 2R_1\longrightarrow R_2$
              \begin{align}
            \myvec{3 & -1| & -8 \\ 6-\brak{2}\brak{3} & -r+\brak{2}\brak{1}| & -16+\brak{2}\brak{8}}=\myvec{3 & -1| & -8\\ 0 & -r+2| & 0}
              \end{align}
              For two lines to be coincident rank of matrix $\sbrak{A|B}$ must be $=1$
              \begin{align}
              \therefore -r+2&=0\\
              \implies r&=2
               \end{align}

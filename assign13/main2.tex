...
where,$k_i$ is  is calculated as follows:-
...
$\therefore$ The area bounded by the curve $y = \sqrt{x}$ and line $x = 2y+3$ in the $1^{st}-quadrant$ is given by:-
\begin{align}
  Area &= \int_{0}^{3} \sqrt{x} \, dx + \int_{3}^{9} \sqrt{x} - \frac{x-3}{2} \, dx\\
  Area &= \frac{2}{3}\sbrak{x^{\frac{3}{2}}}\limits_{0}^{9} \  -\frac{1}{2}\brak{\brak{\frac{9^2}{2}-27}-\brak{\frac{3^2}{2}-9}} \\
   Area &= \frac{2}{3}\brak{\brak{27}-\brak{0}}-\frac{1}{2}\brak{\frac{27}{2}-\frac{-9}{2}}\\
    Area&=18-9\\
    Area&= 9 
\end{align}

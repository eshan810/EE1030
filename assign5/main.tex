...
\solution {
Let $\vec A=\myvec{a \\ 0}$ be the point on $X$ axis equidistant from
 $\vec B=\myvec{-4\\0}$ and $\vec C=\myvec{10\\0}$.\\
\begin{align}
    \brak{\lVert \vec B-\vec A \rVert}^2 &= \brak{\lVert \vec C -\vec A \rVert}^2 \\

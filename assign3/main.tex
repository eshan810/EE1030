...
\begin{align}
	 \vec C&=\frac{kA - B}{k-1} \quad{\brak{where, k=\frac{3}{1}}}\\
	\implies \vec C&=\frac{3\vec A - \vec B}{3 - 1}\\
	\implies \vec C&=\frac{3\vec a - \vec b}{2}\\
	\implies \vec C&=1\cdot5\vec a-0\cdot5\vec b
 \end{align}
